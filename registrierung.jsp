        ...
        <main class="main">
         ...
         <div>
            ...
            ville de residance: <input type="text" name="ort">
                           <br>
            Numero de telephone: <input type="tel" name="telefon">
                           <br>
            Date de Naisssance: <input type="date" name="geburtsdatum">
                           <br>
            Lieux de Naissance: <input type="text" name="geburtsort">
                           <br>
         Nationalite:   <select name="ql_land">
